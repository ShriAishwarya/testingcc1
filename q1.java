...
public class q1 {
	public static void main(String[]args) {
        ...
        driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("shri");
        driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("aishwarya");
        driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("1677446");
